...
class FragmentSobre : androidx.fragment.app.Fragment(){
    ...
    override fun onCreateView(
        ...
        topicoArr.add(sobreTopico(titulo = "Origem do nome", texto = "O nome ‘Conta-me Histórias’ é uma homenagem aos Xutos & Pontapés. Tal como na música do famoso grupo de rock português, também o Conta-me Histórias tem por objetivo contar histórias ao utilizador de algo que este não viu ou do que não se recorda. ", url =  "<iframe width=\"100%\" height=\"100%\" src=\"https://www.youtube.com/embed/b4_ZBr2ijVw\" frameborder=\"0\" allowfullscreen></iframe>"))
